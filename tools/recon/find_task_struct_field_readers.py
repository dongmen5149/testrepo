...
# Known task_struct field offsets (Round 18~32 verified)
KNOWN_FIELDS = [
    0x29e,
    0x274,                              # Round 33 — FUN_00040cec store target (event code)
    # Round 25 신규 cluster #1 + Round 32 의 dominant FUN_00042758 reader
    0x9afc, 0x9b01, 0x9b06, 0x9b14, 0x9b1c, 0x9b3c,
